Feature: Pyspark schema functionality works for relations
  ...
  Scenario Outline: Records with a One to One relation can be validated using the PySpark schema
  ...
  Scenario Outline: Records with a Many to one relation can be validated using the PySpark schema
